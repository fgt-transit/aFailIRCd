...
main(int argc, char *argv[])
{
	...
	int rounds = 0;		/* Not set, hashes may take various rounds */
...
full_usage()
{
	...
	printf("-s Specify a salt, up to 16 for MD5, and up to 22 for Blowfish\n");
...
brief_usage()
{
	...
	printf("      SHA512:  mkpasswd -x [-l saltlength] [-s salt] [-p plaintext]\n");
