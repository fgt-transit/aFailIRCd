...
set_default_conf(void)
{
	...
	ConfigChannel.max_censors = 10;
	ConfigChannel.max_censors_large = 50;
	...
	ConfigChannel.exempt_cmode_y = NO;
	...
	ConfigFileEntry.make_override_immune = NO;
	...
	for(ech = ConfigChannel.exemptchanops; *ech; ech++)
	{
		switch (*ech)
		{
			...
			case 'K':
				...
				break;
			case 'y':
				ConfigChannel.exempt_cmode_y = 1;
				break;
			default:
				conf_report_error("Warning -- invalid mode specified for exemptchanops");
				break;
		}
	}
