...
struct mode_list_t *
allocate_list_item(const char *mstr, const char *who)
{
...
destroy_channel(struct Channel *chptr)
{
	...
	free_channel_list(&chptr->censorlist);
 ...
 */
int
can_send(struct Channel *chptr, struct Client *source_p, struct membership *msptr, char *msg, unsigned int cmd)
{
