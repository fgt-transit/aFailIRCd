...
static struct ConfEntry conf_general_table[] =
{
	...
	{ "make_override_immune", CF_YESNO, NULL, 0, &ConfigFileEntry.make_override_immune },
	{ "\0", 		0, 	  NULL, 0, NULL }
};
...
static struct ConfEntry conf_channel_table[] =
{
	...
	{ "max_censors",	CF_INT,   NULL, 0, &ConfigChannel.max_censors		},
	{ "max_censors_large",	CF_INT,   NULL, 0, &ConfigChannel.max_censors_large	},
	...
	{ "use_censor",		CF_YESNO, NULL, 0, &ConfigChannel.use_censor		},
	...
	{ "exempt_cmode_y",	CF_YESNO, NULL, 0, &ConfigChannel.exempt_cmode_y	},
	{ "\0", 		0, 	  NULL, 0, NULL }
};
