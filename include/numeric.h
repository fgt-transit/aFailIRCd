...
/* Spamfilter numerics, taken from inspircd. *sigh* -- Elizabeth */
#define ERR_CANTUSECENSOR	934
#define ERR_INVALIDCENSOR	935
#define ERR_ALREADYONCENSORLIST	937
#define ERR_NOSUCHCENSOR	938
#define ERR_CENSORLISTFULL	939

#define RPL_CENSORLIST		940
#define RPL_ENDOFCENSORLIST	941
