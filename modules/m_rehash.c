...
{
	const char *cmd;
	void (*handler) (struct Client * source_p, int want_notice);
};

static void
rehash_bans_loc(struct Client *source_p, int want_notice)
{
	if (want_notice)
...
static void
rehash_dns(struct Client *source_p, int want_notice)
{
	if (want_notice)
...
static void
rehash_motd(struct Client *source_p, int want_notice)
{
	if (want_notice)
...
static void
rehash_omotd(struct Client *source_p, int want_notice)
{
	if (want_notice)
		sendto_realops_snomask(SNO_GENERAL, L_ALL,
...
static void
rehash_tklines(struct Client *source_p, int want_notice)
{
...
static void
rehash_tdlines(struct Client *source_p, int want_notice)
{
	struct ConfItem *aconf;
	rb_dlink_node *ptr, *next_ptr;
	int i;
...
static void
rehash_txlines(struct Client *source_p, int want_notice)
{
	struct ConfItem *aconf;
	rb_dlink_node *ptr;
...
static void
rehash_tresvs(struct Client *source_p, int want_notice)
{
	struct ConfItem *aconf;
	rb_dlink_node *ptr;
	rb_dlink_node *next_ptr;
...
static void
rehash_rejectcache(struct Client *source_p, int want_notice)
{
	if (want_notice)
...
static void
rehash_throttles(struct Client *source_p, int want_notice)
{
	if (want_notice)
...
static void
rehash_help(struct Client *source_p, int want_notice)
{
	if (want_notice)
		sendto_realops_snomask(SNO_GENERAL, L_ALL,
...
static void
rehash_nickdelay(struct Client *source_p, int want_notice)
{
	struct nd_entry *nd;
	rb_dlink_node *ptr;
...
static void
rehash_config(struct Client *source_p, int want_notice)
{
	if (want_notice)
	{
