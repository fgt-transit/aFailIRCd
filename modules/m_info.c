...
static struct InfoStruct info_table[] = {
	...
	{
		"make_override_immune",
		OUTPUT_BOOLEAN_YN,
		&ConfigFileEntry.make_override_immune,
		"Controls whether operators with user mode +p are immune from kick"
	},
	{
		"failed_oper_notice",
		OUTPUT_BOOLEAN,
	...
	},
	{
		"max_censors",
		OUTPUT_DECIMAL,
		&ConfigChannel.max_censors,
		"Total +d modes allowed in a channel",
	},
	{
		"max_censors_large",
		OUTPUT_DECIMAL,
		&ConfigChannel.max_censors_large,
		"Total +d modes allowed in a +L channel",
	},
	{
		"max_chans_per_user",
		OUTPUT_DECIMAL,
	...
	},
	{
		"use_censor",
		OUTPUT_BOOLEAN_YN,
		&ConfigChannel.use_censor,
		"Enable +y (channel censor), aka spamfilter",
	},
	{
		"caps_threshold",
		OUTPUT_DECIMAL,
