...
static int m_displaymsg(struct Client *source_p, const char *channel, int underline, int action,
...
static int
m_displaymsg(struct Client *source_p, const char *channel, int underline, int action,
	     const char *nick, const char *text)
{
	...
	strip_unprintable(nick, nick3, NICKLEN + 1);
